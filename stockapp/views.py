...
def Admin_signup(request):
    ...
    if request.method == "POST":
        ...
        if a:
            ...
            us.save()
            r = Admin_Register(user=us, contact_number=contact,
                               age=age, gender=gender, occupation=occu)
            r.save()
...
def Patient_signup(request):
    ...
    if request.method == "POST":
        ...
        if a:
            ...
            us.save()
            r = Patient_Register(
                user=us, contact_number=contact, age=age, gender=gender, occupation=occu)
            r.save()
...
def Doctor_signup(request):
    ...
    if request.method == "POST":
        ...
        if a:
            ...
            us.save()
            r = Doctor_Register(user=us, first_name=fname, last_name=lname,
                                contact_number=contact, age=age, gender=gender, occupation=occu)
            r.save()
...
def Admin_add_patient(request):
    ...
    if request.method == "POST":
        ...
        if a:
            ...
            us.save()
            r = Patient_Register(
                user=us, first_name=fname, contact_number=contact, age=age, gender=gender, occupation=occu)
            r.save()
...
def contactus(request):
    ...
    if request.method == "POST":
        ...
        contact = Contact(name=name, number=contact_number,
...
def screening(request):
    if request.method == "POST":
        ...
        screening_object = Screening(patient_name=patient_name, symptoms=symptoms, complains=complains, bp=bp, temperature=temperature, weight=weight, fever=fever,
                                     pain_condition=pain_condition, physical_appearence=physical_appearence, Deformation=Deformation, appetite=appetite, sleep_conditions=sleep_conditions)
...
def appointment(request):
    ...
    if request.method == "POST":
        ...
        appointment_object = Appointment(doctor=doctor, full_name=full_name, phone_number=phone_number,
                                         email=email, message=message, appointment_time=appointment, appointment_date=appointmentd)
...
def prescription(request):
    ...
    if request.method == "POST":
        ...
        prescription_object = Prescription(
            p_name=patient, medicine=medicine, quantity=quantity, days=days, time=time)
